<nav class="navbar-default navbar-static-side" role="navigation">
    ...
    <li class="treeview sidebar data-master {{
        Request::is('manajemen-pengguna/pengguna') ? 'active' : ''
        || Request::is('manajemen-pengguna/pengguna/*') ? 'active' : ''
        || Request::is('manajemen-hak-akses/group') ? 'active' : ''
        ...
        <ul class="nav nav-second-level collapse">
            <li  class="treeview sidebar data-master {{
                Request::is('manajemen-pengguna/pengguna') ? 'active' : ''
                || Request::is('manajemen-pengguna/pengguna/*') ? 'active' : ''
                }}"><a href="{{url('manajemen-pengguna/pengguna')}}">Manajemen Pengguna</a></li>
