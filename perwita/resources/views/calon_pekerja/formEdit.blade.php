        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered" id="form-pekerja">                           
                         <tr>
                            <th>No KTP</th>
                            <td><input value="{{$pekerja->cp_no_ktp}}" id="ktp" class="form-control huruf" name="No KTP" placeholder="No KTP" required="">
                        ...
                        <tr>
                            <th>Nama Lengkap</th>
                            <td><input value="{{$pekerja->cp_nama}}" id="nama" class="form-control huruf" name="Nama Lengkap" placeholder="Nama Lengkap" required="">
                        ...
                        <tr>
                            <th>Jenis Kelamin</th>
                            <td>
                                <div class="radio-inline"> <input type="radio" name="Jenis Kelamin" id="jk" value="L" required="" @if($pekerja->cp_jenis_kelamin=='L')  checked @endif>Laki-Laki</div>
                                <div class="radio-inline"> <input type="radio" name="Jenis Kelamin" id="jk2" value="P"  required="" @if($pekerja->cp_jenis_kelamin=='P')  checked @endif>Perempuan</div>                                    
                        ...
                        <tr>
                            <th>Tanggal Lahir</th>
                            <td><input value="{{$pekerja->cp_tgl_lahir}}" readonly="" id="tanggal" class="form-control huruf" name="Tanggal Lahir" placeholder="Tanggal Lahir" required="">
                        ...
                        <tr>
                            <th>Alamat</th>
                            <td><input value="{{$pekerja->cp_alamat}}" id="alamat" class="form-control huruf" name="Alamat" placeholder="Alamat" required="">
                        ...
                        <tr>
                            <th>No Telp.</th>
                            <td><input value="{{$pekerja->cp_no_hp}}" id="telp" class="form-control huruf" name="No Telp" placeholder="No Telp." required="">
                        ...
                        <tr>
                            <th>Expired KTP</th>
                            <td><input value="{{$pekerja->cp_expired_ktp}}" readonly="" id="exp" class="form-control huruf" name="Expired KTP" placeholder="Expired KTP" required="">
                        ...
                        <tr>
                            <th>Nama Ibu</th>
                            <td><input value="{{$pekerja->cp_nama_ibu}}" id="ibu" class="form-control huruf" name="Nama Ibu" placeholder="Nama Ibu" required="">
                        ...
                        <tr>
                            <th>Pendidikan</th>
                            <td><input value="{{$pekerja->cp_pendidikan}}" id="pendidikan" class="form-control huruf" name="Pendidikan" placeholder="Pendidikan" required="">
                        ...
                        <tr>
                            ...
                            <input id="p_id" type="" name="_token" value="{{$pekerja->cp_id}}">
                            <th style="width:20%">NIK</th>
                            <td><input value="{{$pekerja->cp_nik}}" id="nik" class="form-control huruf" name="NIK" placeholder="NIK" required="">
                        ...
                        <tr>
                            <th>No KPJ</th>
                            <td><input value="{{$pekerja->cp_no_kpj}}" id="kpj" class="form-control huruf" name="No KPJ" placeholder="kpj" required="">
...
<script type="text/javascript">
    ...
    function Perbarui() {
        ...
        buttonLadda.ladda('start');
         if(validateForm()){
        $.ajax({
            url: baseUrl + '/manajemen-calon-pekerja/data-calon-pekerja/perbarui/'+p_id,
            // type        : 'post',            
            type: 'get',
            timeout: 10000,
