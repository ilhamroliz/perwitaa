...
//    }
    ...
    function table(){
    $.ajax({    
    url: baseUrl + '/laporan-keuangan/laba-rugi/table',
            type: 'get',
            //dataType: 'json',
            timeout: 10000,            
            success: function(response){
                $('.table-labarugi').html(response);
    ...
    $.ajax({    
    url: baseUrl + '/laporan-keuangan/laba-rugi-percobaan/per/'+$('.coba :selected').text(),
            type: 'get',
            //dataType: 'json',
            timeout: 10000,            
            success: function(response){
    ...
    throwLoadError(message);
            ...
            $('.load-neraca').css('display','');
    $.ajax({    
    url: baseUrl + '/laporan-keuangan/laba-rugi-percobaan/periode/'+$('.coba :selected').text(),
            type: 'get',
            //dataType: 'json',
            timeout: 10000,            
            success: function(response){
    ...
    throwLoadError(message);
        ...
        if($('.jenis').val()=='2' && $('.laporan').val()=='1'){    
            ...
            $('.load-neraca').css('display','');
    $.ajax({    
    url: baseUrl + '/laporan-keuangan/laba-rugi-final/per/'+$('.final :selected').text(),
            type: 'get',
            //dataType: 'json',
            timeout: 10000,            
            success: function(response){
    ...
    throwLoadError(message);
        ...
        if($('.jenis').val()=='2' && $('.laporan').val()=='2'){
            ...
            $('.load-neraca').css('display','');
            $.ajax({                  
    url: baseUrl + '/laporan-keuangan/laba-rugi-final/periode/'+$('.final').val(),
            type: 'get',
            //dataType: 'json',
            timeout: 10000,            
            success: function(response){
