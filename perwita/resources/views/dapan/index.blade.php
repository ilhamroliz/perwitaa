...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox-title ibox-info">
        <h5>Dapan</h5>
        <a href="{{ url('manajemen-bpjs/ansuransi/dapan/cari') }}" style="float: right; margin-top: -7px; margin-right: 10px;" class="btn btn-info btn-flat" type="button"><i class="fa fa-search"></i>&nbsp;Cari</a>
    </div>
    <div class="ibox">
...
var table;
    ...
    function simpan(id){
      ...
      $.ajax({
        ...
        url: baseUrl + '/manajemen-bpjs/ansuransi/dapan/simpan/'+id,
        dataType: 'json',
