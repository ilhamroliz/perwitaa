...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form id="form-mitra">
                        <input type="hidden" value="{{$mitra->m_id}}" class="form-control" name="m_id" id="m_id">
                        <div class="form-group row">
                            <label for="Nama" class="col-sm-2 col-form-label">Nama Mitra</label>
                            <div class="col-sm-10">                                
    <input value="{{$mitra->m_name}}" type="text" class="form-control" name="Nama Mitra" id="Nama" placeholder="Nama Mitra" required="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{$mitra->m_address}}" type="text" class="form-control" name="Alamat" id="Alamat" placeholder="Alamat Mitra" required="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{$mitra->m_phone}}" onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="form-control" name="No_Telp" id="Telp" placeholder="No Telp." required="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{$mitra->m_fax}}" onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="form-control" name="Fax" id="Fax" placeholder="No Fax" required="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input  value="{{$mitra->m_note}}" type="text" class="form-control" name="Keterangan" id="Keterangan" placeholder="Keterangan" required="">
                        ...
                        <div class="hr-line-dashed"></div>
                                <div class="form-group row">
                                    <div class="col-sm-4 col-sm-offset-9">
                                        <a href="{{ url('manajemen-mitra/data-mitra') }}" class="btn btn-danger btn-flat" type="button">Kembali</a>
