                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Form Tambah Data Akses Group</h5>
                        ...
                        <div class="ibox-content">
                            <table class="table table-striped table-borderred formProfil">
                                <tr>                                                                    
                                    ...
                                    <td><input type="text" class="form-control huruf" name="Nama Group" placeholder="Nama Group"></td>
                                </tr>                                                             
                            </table>
                            ...
                            <table class="table table-striped table-borderred formProfil">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$index+1}}</td>
                                        <td>
                                            <input name="menu{{$index}}" value="{{$data->a_id}}" class="form-control">
                                            {{$data->a_type}}</td>
                                        <td>
<input  id="radio1" type="checkbox" name="level{{$index}}" value="1"><label>Lihat</label>
                                        </td>
                                        <td>
<input  id="radio1" type="checkbox" name="level{{$index}}" value="2"><label>Lihat, Edit</label>
                                        </td>
                                        <td>
<input  id="radio1" type="checkbox" name="level{{$index}}" value="3"><label>Lihat, Tambah, Edit, Hapus</label>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
