                ...
                <div class="ibox-content">
                    <form id="form-mitra-contract">                        
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              {{--   @foreach($update_mitra_contract as $update_mitra_contract) --}}
                                ...
                                <input value="{{$update_mitra_contract->mc_contractid}}" type="hidden" class="form-control" name="mc_contractid" id="mc_contractid" required="">                                     
                         {{--        @endforeach --}}
                         ...
                         <div >
                        {{--  <input type="hidden" name="mc_contractid" id="mc_contractid" value="{{$update_mitra_contract->mc_contractid}}" > --}}
                         <input type="hidden" name="mitra" id="mitra" value="{{$update_mitra_contract->mc_mitra}}" >                     
                        <div class="form-group row" >
                         ...
                         <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$update_mitra_contract->c_id}} ({{$update_mitra_contract->c_name}} )" readonly="" class="form-control" name="perusahaan" data-perusahaan id="perusahaan" required="" placeholder="Masukkan Nama Perusahaan"></input>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$update_mitra_contract->m_id}}" readonly="" class="form-control" name="mitra" data-input-mitra id="mitra" required="" placeholder="Masukkan Nama Mitra">{{-- {{$update_mitra_contract->m_name}} --}}                                                                       
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-10">
                                <input readonly="" class="form-control" value="{{$update_mitra_contract->md_id}} {{-- ({{$update_mitra_contract->md_name}}) --}}" name="divisi" data-input-divisi id="divisi" required="" placeholder="Masukkan Nama Mitra">                                                                       
                                <span style="color:#ed5565;display:none" class="help-block m-b-none reset" id="mitra-error">
                                    <small>Nama Mitra harus diisi...!</small>
                                </span>
                            </div>
                       ...
                       <div class="form-group row">
                         <input type="hidden" name="statusmp" value="{{$update_mitra_contract->mc_status_mp}}">
                       ...
                       <div class="form-group row" >
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-sm-3">
                                ...
                                <input readonly="" class="form-control" name="mp_selection_date" value="{{$d->mp_selection_date}}" id="mp_selection_date"  required="">
                                <span style="color:#ed5565;display:none" class="help-block m-b-none reset" id="tglKontrak-error">
                                    <small>Tanggal Kontrak harus diisi...!</small>
                                </span>
                            </div>
                            <label for="tglBatas" class="col-sm-2 col-form-label">Tanggal Hasil Seleksi</label>
                            <div class="col-sm-3">
                                <input readonly class="form-control" name="mp_workin_date" value="{{$d->mp_workin_date}}" id="mp_workin_date" required="">
                                <span style="color:#ed5565;display:none" class="help-block m-b-none reset" id="tglBatas-error">
                                    <small>Batas Kontrak harus diisi...!</small>
                                </span>
                            </div>
                        ...
                        <table class="table table-bordered table-striped pilihMitraPekerja">
                            ...
                            <tbody>                            
                                ...
                                <tr @if($data->mp_pekerja!='') style="background: #bbc4d6;" @endif class="select-{{$index}}" onclick="select({{$index}})">                                    
                                    <td>
                                        <input type="hidden" name="chek[]" @if($data->mp_pekerja!='') value="1" @endif class="chek-all chek-{{$index}}">
                                    ...
                                    <td><input type="text"  name="mitra_nik[]" value="{{$data->p_nik}}"></td>
        <td style="display: none;" style="width: 2px"><input style="width: 50px" class="a-{{$index}} form-control " name="a[]" value="@if($data->mp_pekerja!='')1 @elseif($data->mp_pekerja=='') 0 @endif"></td>    
        <td style="display: none ;" style="width: 2px"><input style="width: 50px"  class="b-{{$index}} form-control" name="b[]" value="0" ></td>    
                                </tr>
                                @endforeach

  {{--                               @foreach($asw as $index => $data)
                                                        
                                <tr @if($data->mp_pekerja!='') style="background: #bbc4d6;" @endif class="pencet-{{$index}}"
                                 onclick="pencet({{$index}})">                                    
                                    <td>
                                        <input type="hidden" name="chek[]" @if($data->mp_pekerja!='') value="1" @endif class="chek-all chek-{{$index}}">
                                        <input type="hidden" name="pekerja[]" value="{{$data->p_id}}">
                                        <input  @if($data->mp_pekerja!='') checked="checked" @endif class="milih-{{$index}}" type="checkbox" name="pilih[]" onclick="selectBox({{$index}});cekAB({{$index}});">                                        
                                    </td>
                                    <td>{{$data->p_name}}</td>
                                    <td>{{$data->p_sex}}</td>
                                    <td>{{$data->p_address}}</td>
                        ...
                        <div class="hr-line-dashed"></div>
                                <div class="form-group row">
                                    <div class="col-sm-4 col-sm-offset-9">
                                        ...
                                        <button class="ladda-button ladda-button-demo btn btn-primary btn-flat simpan" type="button" id="button" onclick="perbarui()">
                                            Simpan
                                        </button>
                                    </div>
                                </div>
