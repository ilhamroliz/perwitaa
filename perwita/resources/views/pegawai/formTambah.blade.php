            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered" id="form-pegawai">
                        ...
                        <tr>
                            <th>Tempat Lahir</th>
                            <td><input id="tempat" class="form-control huruf" name="Tempat Lahir" placeholder="Tempat Lahir" required="">
                        ...
                        <tr>
                            ...
                            <td><input readonly id="tmk" class="form-control huruf" name="Tanggal Masuk Kerja" placeholder="Tanggal Masuk Kerja" required="">
                        ...
                        <tr>
                            <th>No KTP</th>
                            <td><input id="ktp" class="form-control huruf" name="No KTP" placeholder="No KTP" required="">
                        ...
                        <tr>
                            <th>No Rekening</th>
                            <td><input id="rekening" class="form-control huruf" name="No Rekening" placeholder="No Rekening" required="">
                        ...
                        <tr>
                            <th>No KPK</th>
                            <td><input id="kpk" class="form-control huruf" name="No KPK" placeholder="No KPK" required="">
                        ...
                        <tr>
                            <th>No JP</th>
                            <td><input id="jp" class="form-control huruf" name="No JP" placeholder="No JP" required="">
...
<script type="text/javascript">
    ...
    function simpan() {
        ...
        buttonLadda.ladda('start');
         if(validateForm()){
        $.ajax({
            url: baseUrl + '/manajemen-pegawai/data-pegawai/simpan',
            // type        : 'post',            
            type: 'get',
            timeout: 10000,
