	...
	<div id="inner">
		...
		<div id="hd">
            ...
            <div class="image" id="showimage">
                  ...
                  <img src="{{asset('assets/img/user.jpg')}}" class="img-rounded" alt="Cinque Terre" width="150" height="130">
							@else
									<center><img src="{{url('/')}}/{{$lempar['p_img']}}" width='150' class='thumb-image img-responsive'></center>
							@endif
						</div>
					</div><!--// .contact-info -->
				</div>
