...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox-title">
      ...
      <a href="{{url('manajemen-pegawai/pegawairemunerasi')}}" style="float: right; margin-top: -7px;" class="btn btn-outline btn-primary btn-flat"><i class="fa fa-plus">&nbsp;</i>Tambah</a>
    </div>
    <div class="ibox">
