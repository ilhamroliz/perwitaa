...
<table class="int">
        ...
        <tr>
            ...
            <td >{{ $tl}},{{ \Carbon\Carbon::parse($ttl)->format('M d,Y')}}</td>
        </tr>
        <tr>
            <td >Address</td><td >:</td>
            <td >{{ $alamat}}</td>
...
<p class="she">She has employed by {{ $i}} as an {{$jabatan}} from</p>
<p class="tnda">telah bekerja di {{ $i}}  sebagai {{$jabatan}} sejak </p>

<p class="s">{{ \Carbon\Carbon::parse($tgl_m)->format('F d,Y')}} - {{ \Carbon\Carbon::parse($tgl_b)->format('F d,Y')}}</p>
...
<br>
<p class="mks">Sidoarjo, {{ \Carbon\Carbon::parse($tgl)->format('F d,Y')}}
<p/>
<p class="a">Sincerely,
</p>
<br><br><br><br><br>
