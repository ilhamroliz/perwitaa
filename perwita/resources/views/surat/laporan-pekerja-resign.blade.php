...
<br>
<p>Dengan hormat,</p>
<p class="se">Sehubungan dengan surat pengajuan pengunduran diri dari pemohon sebagai pekerja {{ $surat->mitra }} Maka bersama ini kami beritahukan bahwa : </p>
...
<p>Bahwa yang bersangkutan sudah tidak bekerja lagi sebagai pekerja {{ $surat ->mitra }}</p>
