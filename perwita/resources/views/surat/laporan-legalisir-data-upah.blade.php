...
<p>Menerangkan dengan sebenarnya bahwa alamat tersebut sudah benar sama dengan alamat di KTP yang lama pekerja {{$a}} yang dipekerjakan di {{$surat->mitra}} yaitu {{$surat->nama}} yang terkait dalam buku tabungan Dapan Maspion. </p>

<p> Demikian Surat Keterangan kami, atas perhatian dan bantuan  yang diberikan kami ucapkan terima kasih</p>
<br>
<pre class="mks">Sidoarjo, {{ $surat->tgl }}<pre/>
<p class="s">{{ $surat->j_pj }},</p>
