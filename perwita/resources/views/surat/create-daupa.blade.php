...
<div class="ibox-content">
    ...
    <div class="row">
        ...
        <select class="form-control" onchange="location = this.value;">
            ...
            <option value="create-daupa" style="color: grey;"  selected="true" disabled="" >Surat Permohonan Legalisir Data Upah</option>
     ...
     <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="nik"  class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" value="Data Upah" name="kop_surat" id="kop_surat" placeholder="Masukkan No kartu" >
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            @endif
                              ...
                              <div class="form-group row">
                            <label for="tempat" class="col-sm-2 col-form-label">Nomor Rekening</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="no_rek" id="no_rek" value="{{old('jabatan')}}" placeholder="Masukkan Nomor Rekening" >
        
                                 @if($errors->has('no_rek'))
                                <small style="color: #ed5565">{{ $errors->first('no_rek')}}</small>
                            @endif
                            </div>
                        </div>
...
/*function cetak(){
    ...
    window.open(baseUrl + '/surat/laporan-legalisir-data-upah?' + data ,"_blank");   
    } 
