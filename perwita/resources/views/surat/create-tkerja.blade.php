...
<div class="wrapper wrapper-content animated fadeInRight">
 ...
 <form id="form-pekerja" method="get" action="store">
  <h5>Jenis Surat</h5>
...
<div class="ibox-content">
    ...
    <div class="row">
        ...
        <select class="form-control" onchange="location = this.value;">
            ...
            <option value="create-tkerja" style="color: grey;" disabled selected="true">Surat Keterangan Tidak lagi Bekerja</option>
     ...
     <div class="form-group row">
                            ...
                            @if($errors->has('id_surat'))
                                <small style="color: #ed5565">{{ $errors->first('id_surat')}}</small>
                            @endif
...
readonly="true" placeholder="Masukkan No kartu" >
                ...
                <div class="ibox-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" name="n_pj" id="npj" placeholder="Masukkan Nama" >
                                     @if($errors->has('n_pj'))
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="j_pj" id="j_pj" placeholder="Masukkan Jabatan" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="a_pj" id="a_pj" placeholder="Masukkan Alamat" >
  ...
  <div class="ibox-content">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                             <input type="hidden" id="nama" name="nama" class="form-control tujuan"/>
                                <input type="text" class="form-control" name="nama" id="nama1" placeholder="Masukkan Nama" >
                                 @if($errors->has('nama'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly="" class="form-control" name="tgl_m" id="tgl_m" placeholder="Masukkan Tanggal Mulai Bekerja" >
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly="" class="form-control" name="tgl_b" id="tgl_b" placeholder="Masukkan Tanggal Berhenti Bekerja" >
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4 col-sm-offset-9">
                                        ...
                                        <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                                          {{--  <a onclick="cetak()" class="ladda-button ladda-button-demo btn btn-warning btn-flat">Cetak</a> --}}
                                       
                                     {{--     <input  onclick="simpan()" class="ladda-button ladda-button-demo btn btn-primary btn-flat simpan" type="button" name="Insert" value="simpan"> --}}
...
/*function cetak(){
    ...
    window.open(baseUrl + '/surat/laporan-tidak-lagi-bekerja?' + data ,"_blank");   
    }; 
    function simpan(){
      $.ajax({
        url: baseUrl+'/surat/store1',
        type:'get',
        data:$('.red').serialize(),
