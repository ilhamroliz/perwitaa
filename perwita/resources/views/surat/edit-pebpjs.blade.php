...
readonly="true" placeholder="Masukkan No kartu" >
  ...
  <div class="ibox-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="kpk" value="{{ $surat->p_kpk }}" id="kpk" placeholder="Masukkan Nomor KPK">
                 @if($errors->has('kpk'))
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="kpj" value="{{ $surat->p_kpj }}" id="kpj" placeholder="Masukkan Nomor KPJ">
         @if($errors->has('kpj'))
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="bu" value="{{ $surat->p_bu }}" id="bu" placeholder="Masukkan Nomor BU">
         @if($errors->has('bu'))
