...
readonly="true" placeholder="Masukkan No kartu" >
  ...
  <div class="ibox-content">
                         ...
                         <label for="tempat" class="col-sm-2 col-form-label">Gaji</label>
                           <div class="col-sm-10"> 
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" id="gaji" name="gaji" value="{{$surat->gaji}}" placeholder="Masukkan gaji">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="tl" id="tl" readonly="true" value="{{ $surat->tempat_lahir}}" placeholder="Masukkan Jabatan" >
                        @if($errors->has('tl'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" readonly="true" class="form-control" name="ttl" value="{{ $surat->tgl_lahir}}" id="ttl" placeholder="Masukkan Alamat">
                        @if($errors->has('ttl'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                             <SELECT name="divisi" id="divisi" class="form-control">
                                <option value="" selected="true">-Pilih Subinstansi-</option>
                                  @foreach ($d_mitra_divisi as $b)
                                            <option value="{{ $b -> md_id }}">{{$b -> md_name}}</option>
                                    @endforeach
                             </SELECT>
                              @if($errors->has('divisi'))
                                <small style="color: #ed5565">{{ $errors->first('divisi')}}</small>
                            @endif
                            </div>
                        </div>
...
$("select[name='divisi']").val('{{ $surat->divisi or ''}}')
