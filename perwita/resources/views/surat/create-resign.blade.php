...
<div class="ibox-content">
    ...
    <div class="row">
        ...
        <select class="form-control" onchange="location = this.value;">
            ...
            <option value="create-resign" style="color: grey;"  disabled selected="true" >Surat Laporan Pekerja Resign</option>
...
readonly="true" placeholder="Masukkan No kartu" >
                        ...
                        <div class="form-group row">
                            <label for="nik"  class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" value="Keterangan Resign" name="kop_surat" id="kop_surat" placeholder="Masukkan No kartu" >
                            </div>
                        </div>
