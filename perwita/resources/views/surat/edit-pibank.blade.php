...
readonly="true" placeholder="Masukkan No kartu" >
  ...
  <div class="ibox-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="tl" id="tl" readonly="true" value="{{ $surat->tempat_lahir}}" placeholder="Masukkan tempat Lahir" >
                        @if($errors->has('tl'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" readonly="true" class="form-control" name="ttl" value="{{ $surat->tgl_lahir}}" id="ttl" placeholder="Masukkan Tanggal Lahir">
                        @if($errors->has('ttl'))
