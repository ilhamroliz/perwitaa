...
<div class="wrapper wrapper-content animated fadeInRight">
 ...
 <form id="form-pekerja" method="get" action="store3">
  <h5>Jenis Surat</h5>
...
<div class="ibox-content">
    ...
    <div class="row">
        ...
        <select class="form-control" onchange="location = this.value;">
            ...
            <option value="create-pibank" style="color: grey;" disabled selected="true">Surat Pengajuan Pinjaman Bank</option>
     ...
     <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="nik"  class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" value="Peminjaman Bank" name="kop_surat" id="kop_surat" placeholder="Masukkan No kartu" >
                            </div>
                        </div>
  ...
  <div class="ibox-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <small style="color: #ed5565">{{ $errors->first('tempat_lahir')}}</small>
                            @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <small style="color: #ed5565">{{ $errors->first('tgl_lahir')}}</small>
                            @endif
                            </div>
                        </div>
                          <div class="form-group row">
