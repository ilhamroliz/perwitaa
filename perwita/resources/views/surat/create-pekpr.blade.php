...
<div class="wrapper wrapper-content animated fadeInRight">
 ...
 <form id="form-pekerja" method="get" action="store5">
  <h5>Jenis Surat</h5>
...
<div class="ibox-content">
    ...
    <div class="row">
        ...
        <select class="form-control" onchange="location = this.value;">
            ...
            <option value="create-pebpjs" style="color: black;">Surat Pengantar Pendaftaran BPJS kesehatan</option>
            <option value="create-pekpr" style="color: grey;" disabled selected="true">Surat Keterangan Kerja Pengajuan KPR</option>
        </select>
    </div>
    </div>
     <div class="form-group row">
                            ...
                            @if($errors->has('id'))
                                <small style="color: #ed5565">{{ $errors->first('id')}}</small>
                            @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control"  name="no_surat" id="no_surat" value="{{$itung}}/{{$bulan}}{{$year}}" readonly="true" placeholder="Masukkan No kartu" >
                            @if($errors->has('no_surat'))
                                <small style="color: #ed5565">{{ $errors->first('no_surat')}}</small>
                            @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly="" class="form-control" name="tgl" id="tgl" placeholder="Masukkan Tempat Lahir" readonly="true">
                        ...
                        <div class="form-group row">
                            <label for="nik"  class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" value="Pengajuan KPR" name="kop_surat" id="kop_surat" placeholder="Masukkan No kartu" >
                            </div>
                        </div>
  ...
  <div class="ibox-content">
                         ...
                         <div class="form-group row">
                          ...
                          <div class="form-group row">
                           ...
                           <div class="form-group row">
                         <label for="tempat" class="col-sm-2 col-form-label">Gaji</label>
                           <div class="col-sm-10"> 
                            <div class="input-group">
                              <div class="input-group-addon">RP.</div>
                              <input type="text" class="form-control" id="gaji" name="gaji"  value="{{old('gaji')}}" placeholder="Masukkan gaji">
                              <div class="input-group-addon">,00</div>
                            </div>
                            @if($errors->has('gaji'))
                                <small style="color: #ed5565">{{ $errors->first('gaji')}}</small>
                            @endif
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="tl" id="tl" value="{{old('tl')}}" placeholder="Masukkan Jabatan" >
                                 @if($errors->has('tl'))
                                <small style="color: #ed5565">{{ $errors->first('tl')}}</small>
                            @endif
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="tempat" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                            <div class="col-sm-10">
                                <input type="text" readonly="true" class="form-control" name="ttl" value="{{old('ttl')}}" id="ttl" placeholder="Masukkan Alamat">
                                 @if($errors->has('ttl'))
                                <small style="color: #ed5565">{{ $errors->first('ttl')}}</small>
                            @endif
                            </div>
                        </div>
                          <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                             <SELECT name="divisi" id="divisi" class="form-control" value="{{old('divisi')}}">
                                <option value="" selected="true">-Pilih Divisi-</option>
                                  @foreach ($divisi as $b)
                                            <option value="{{ $b -> md_id }}">{{$b -> md_name}}</option>
                                    @endforeach
                             </SELECT>
                              @if($errors->has('mitra'))
                                <small style="color: #ed5565">{{ $errors->first('mitra')}}</small>
...
$('#no_surat').val(( {{$itung}} + "/" + this.value + "/" + "{{$bulan}}" + "{{$year}}"));
      ...
      $('#gaji').maskMoney({prefix:'', thousands:'.', precision:0});
