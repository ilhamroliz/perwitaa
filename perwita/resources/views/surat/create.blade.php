...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <form id="form-pekerja" method="get" action="store1">
                    <h5>Jenis Surat</h5>
                    ...
                    <div class="row">
                        ...
                        <select class="form-control" onchange="location = this.value;">
                            ...
                            <option value="create" style="color: grey;" disabled selected="true">Surat Keterangan Pengalaman Kerja</option>
                        ...
                        <div class="form-group row">
                            <label for="nik"  class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" value="Pengalaman Kerja" name="kop_surat" id="kop_surat" placeholder="Masukkan No kartu" >
                            </div>
                        </div>
  ...
  <div class="ibox-content">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                             <input type="hidden" id="nama" name="nama" class="form-control tujuan"/>
                                <input type="text" class="form-control required" name="nama" id="nama1"  value="{{old('nama')}}" placeholder="Masukkan Nama" >
                                 @if($errors->has('nama'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control required" name="jabatan" id="jabatan" value="{{old('jabatan')}}" placeholder="Masukkan Jabatan" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="tl" id="tl" value="{{old('tl')}}" placeholder="Masukkan Tempat Lahir" >
                            @if($errors->has('tl'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly="true" class="form-control" name="ttl" value="{{old('ttl')}}" id="ttl" placeholder="Masukkan Tanggal lahir">
         @if($errors->has('ttl'))
