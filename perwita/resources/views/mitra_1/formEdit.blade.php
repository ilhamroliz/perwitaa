                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered" id="form-mitra">
                        ...
                        <tr>
                            ...
                            <input type="" name="_token" value="{{$mitra->m_id}}" class="id_mitra">
                            <th style="width:20%">Nama Mitra</th>
                            <td><input id="nama" value="{{$mitra->m_name}}" class="form-control huruf" name="Nama Mitra" placeholder="Nama Mitra" required="">
                        ...
                        <tr>
                            <th>Alamat</th>
                            <td><input id="alamat" value="{{$mitra->m_address}}" class="form-control huruf" name="Alamat" placeholder="Alamat" required="">
                        ...
                        <tr>
                            <th>No Telp.</th>
                            <td><input id="telp" value="{{$mitra->m_phone}}" class="form-control huruf" name="No Telp." placeholder="No Telp." required="">
                        ...
                        <tr>
                            <th>Divisi</th>
                            <td><input id="divisi" value="{{$mitra->m_divisi}}" class="form-control huruf" name="Divisi" placeholder="Divisi" required="">
                        ...
                        <tr>
                            ...
                            <td><input id="pengawas" value="{{$mitra->m_pengawas_lapangan}}" class="form-control huruf" name="Pengawas Lapangan" placeholder="Pengawas Lapangan" required="">
                        ...
                        <tr>
                            <th>Program Kerja</th>
                            <td><input id="program" value="{{$mitra->m_program_kerja}}" class="form-control huruf" name="Program Kerja" placeholder="Program Kerja" required="">
