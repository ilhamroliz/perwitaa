                ...
                <form class="formapprovalpenjualan" id="formapprovalpenjualan">
                    <table id="tabel-penjualan" class="table table-bordered table-striped" >
                        ...
                        <tbody>
                          ...
                          <td>
                              <input class="pilih-{{$index}}" type="checkbox" name="pilih[]" onclick="selectBox({{$index}})" value="{{$x->s_id}}">
                          </td>
                            <td>{{ Carbon\Carbon::parse($x->s_date)->format('d/m/Y H:i:s') }}</td>
                            <td>{{ $x->m_name}}</td>
                            <td>{{ $x->s_nota}}</td>
                            <td><span style="float: left;">Rp. </span><span style="float: right">{{ number_format($x->s_total_net, 0, ',', '.') }}</span></td>
                            <td align="center">
                            <button type="button" title="Detail" onclick="detail({{$x->s_id}})" id="detailbtn" class="btn btn-info btn-sm" name="button"> <i class="glyphicon glyphicon-folder-open"></i> </button>
                            <button type="button" title="Setujui" onclick="setujui({{$x->s_id}})" class="btn btn-primary btn-sm" name="button"> <i class="glyphicon glyphicon-ok"></i> </button>
                            <button type="button" title="Tolak" onclick="tolak({{$x->s_id}})"  class="btn btn-danger btn-sm" name="button"> <i class="glyphicon glyphicon-remove"></i> </button>
                           </td>
                        </tr>
                        @endforeach
                        </tbody>
