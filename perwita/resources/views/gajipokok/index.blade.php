...
<script type="text/javascript">
    ...
    $('#caripekerja').autocomplete({
        source: baseUrl + '/manajemen-payroll/payroll/gaji/getdata',
    ...
    function getdata(data){
        ...
        table.row.add([
            ...
            info.p_nip,
            info.p_nip_mitra,
            '<input type="text" name="gajipokok[]" value="Rp. '+accounting.formatMoney(info.p_gaji_pokok, "", 0, ".", ",")+'" class="form-control gajipokok" style="width: 100%;" placeholder="Masukkan Gaji Pokok">',
            '<input type="hidden" name="pekerja[]" value="'+info.p_id+'" class="form-control">',
            ]).draw();

        $('.gajipokok').maskMoney({prefix:'Rp. ', thousands:'.', decimal:',', precision:0});
    }
    ...
    function simpan(){
        ...
        $.ajax({
            url: '{{ url('manajemen-payroll/payroll/gaji/simpan') }}',
            type: 'post',
            data: $('#data').serialize(),
    ...
    function cari(){
      ...
      $.ajax({
        ...
        url: baseUrl + '/manajemen-payroll/payroll/gaji/cari',
        dataType: 'json',
        success : function(result){
          for (var i = 0; i < result.length; i++) {
            ...
            html += '<tr role="row" class="odd">'+
                  ...
                  '<td><input type="text" name="gajipokok[]" value="Rp. '+accounting.formatMoney(result[i].p_gaji_pokok, "", 0, ".", ",")+'" class="form-control rp" style="width: 100%;" placeholder="Masukkan Gaji Pokok"></td>'+
