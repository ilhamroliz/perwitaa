...
return [
    ...
    */
    ...
    'no_kartu' => [
        'required' => 'kolom NOMOR KARTU harus di isi',
        'unique' => 'kolom NOMOR KARTU sudah ada',
    ],

    'npp' => [
        'required' => 'kolom NPP harus di isi',
    ],
    ...
    'h_keluarga' => [
        'required' => 'kolom HUBUNGAN KELUARGA harus di isi',
    ],
    'TMT' => [
        'required' => 'kolom TMT harus di isi',
    ],
     'nf_1' => [
        'required' => 'kolom NAMA FAKSES harus di isi',
    ],
     'kelas' => [
     ...
     'ns_instansi' => [
        'required' => 'kolom MITRA Atau SUB INSTANSI harus di pilih',
    ],
     'n_pj' => [
        'required' => 'kolom NAMA PENANGGUNG JAWAB harus di isi',
    ],
    'a_pj' => [
        'required' => 'kolom ALAMAT PENANGGUNG JAWAB harus di isi',
    ],
    'j_pj' => [
      'required' => 'kolom JABATAN PENANGGUNG JAWAB harus di isi',
    ],
     'instansi' => [
      'required' => 'kolom INSTANSI harus di pilih',
    ],
    'nama' => [
      'required' => 'kolom NAMA harus di isi',
    ],
    ...
    'tgl_b' => [
      'required' => 'kolom MULAI BEKERJA harus di isi',
    ],
    'tgl_m' => [
      'required' => 'kolom BERHENTI BEKERJA harus di isi',
    ],
     'tl' => [
      'required' => 'kolom TEMPAT KERJA harus di isi',
    ],
     'ttl' => [
      'required' => 'kolom TANGGAL LAHIR harus di isi',
    ],
